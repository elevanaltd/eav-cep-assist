...
(function() {
    ...
    var MetadataForm = {
        ...
        setupEventListeners: function() {
            ...
            csInterface.addEventListener("com.elevana.clip-selected", function(event) {
                ...
                try {
                    ...
                    var clip, clipIndex, totalClips, filteredClips;
                    if (data.clip) {
        ...
        setupSearchableDropdown: function() {
            var self = this;
            var input = this.elements.shotType;
            var dropdown = document.getElementById('shotTypeDropdown');
            ...
            input.addEventListener('keydown', function(e) {
                var visibleOptions = Array.from(options).filter(function(opt) {
            ...
            function filterOptions(searchTerm) {
                var search = searchTerm.toUpperCase().trim();
                var visibleCount = 0;
                highlightedIndex = -1;
        ...
        loadClipIntoForm: function(clip) {
            ...
            var identifierValue = clip.identifier || clip.name || '';
            ...
            var descriptionValue = clip.description || '';
            ...
            var goodValue = (clip.good === 'true' || clip.good === true);
        ...
        updateGeneratedName: function() {
            ...
            var actionVisible = this.elements.actionGroup.style.display !== 'none';
        ...
        applyMetadata: function() {
            ...
            var escapedMetadataJson = metadataJson.replace(/'/g, "\\'");
            var script = 'EAVIngest.updateClipMetadata("' + escapedNodeId + '", JSON.parse(\'' + escapedMetadataJson + '\'))';
            ...
            csInterface.evalScript(script, function(result) {
                try {
                    ...
                    if (data.success) {
                        ...
                        try {
                            var metadataEvent = new CSEvent("com.elevana.metadata-applied", "APPLICATION");
        ...
        updateNavigationButtons: function() {
            var clipIndex = navigationContext.clipIndex;
            var totalClips = navigationContext.totalClips;
        ...
        navigatePrevious: function() {
            var clipIndex = navigationContext.clipIndex;
            var filteredClips = navigationContext.filteredClips;

            if (clipIndex > 0 && filteredClips.length > 0) {
                var previousClip = filteredClips[clipIndex - 1];
        ...
        navigateNext: function() {
            ...
            if (clipIndex < filteredClips.length - 1 && filteredClips.length > 0) {
                var nextClip = filteredClips[clipIndex + 1];
