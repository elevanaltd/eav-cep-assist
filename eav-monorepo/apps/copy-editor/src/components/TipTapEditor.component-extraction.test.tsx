...
import type { ComponentData } from '@workspace/shared/scripts';
...
// Mock script service
vi.mock('@workspace/shared/scripts', () => ({
...
describe('TipTapEditor - Component Extraction', () => {
  ...
  describe('extractComponents callback', () => {
    it('should call extractComponentsFromDoc with editor document and hash function', async () => {
      const { generateContentHash } = await import('@workspace/shared/scripts');
