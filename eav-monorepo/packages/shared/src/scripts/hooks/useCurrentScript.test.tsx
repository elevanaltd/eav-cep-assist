...
import { useScriptStore } from '../domain/scriptStore'
import type { ReactNode } from 'react'

// Mock service modules
vi.mock('../domain/scriptService', () => ({
  loadScriptForVideo: vi.fn(),
  saveScript: vi.fn(),
  updateScriptStatus: vi.fn(),
}))

// Hoist mock client declaration to prevent temporal dead zone error
...
vi.mock('../../lib/client/browser', () => ({
  ...
  supabase: mockSupabaseClient, // Deprecated export, kept for compatibility
}))
