...
import { saveScript, updateScriptStatus, saveScriptWithComponents } from '../domain/scriptService'
import { useScriptStore } from '../domain/scriptStore'
import type { Script, ScriptWorkflowStatus, ComponentData } from '../domain/scriptService'
