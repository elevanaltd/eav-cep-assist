...
vi.mock('../../scripts/domain/scriptService', () => ({
...
// Mock capabilities for testing (all features enabled)
...
describe('useComments', () => {
  ...
  describe('Query State', () => {
    it('returns empty threads when no script selected', () => {
      const { result } = renderHook(() => useComments(null, null, mockCapabilities), {
