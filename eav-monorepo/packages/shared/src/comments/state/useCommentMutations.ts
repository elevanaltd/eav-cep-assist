...
import { createComment, updateComment, resolveComment, unresolveComment, deleteComment } from '../domain/repository'
import { getSupabaseClient } from '../../lib/client/singleton'
import { useAuth } from '../../auth/AuthContext'
import { useCommentStore } from './commentStore'
import type { CreateCommentData, CommentWithRecovery } from '../domain/types'
 ...
 */
export const useCommentMutations = (capabilities: CommentCapabilities) => {
  ...
  const createMutation = useMutation({
    ...
    mutationFn: async (data: CreateCommentData) => {
      ...
      const result = await createComment(supabase, data, currentUser.id, capabilities)
