...
import * as commentsLib from '../domain/repository'
import type { CommentWithUser } from '../domain/types'
import type { CommentResult } from '../domain/repository'
...
// Mock capabilities for testing (flexible mode - all features enabled)
const mockCapabilities: CommentCapabilities = {
  requireAnchors: true,
...
describe('useCommentMutations - Integration Tests (Testguard-Approved)', () => {
  ...
  describe('createMutation', () => {
    it('RED STATE: should create comment and invalidate cache', async () => {
      ...
      const { result } = renderHook(() => useCommentMutations(mockCapabilities), {
